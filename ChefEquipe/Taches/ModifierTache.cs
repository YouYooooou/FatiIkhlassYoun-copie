...
namespace FatiIkhlassYoun
{
    public partial class ModifierTache : Form
    {
        ...
        private void btnModifier_Click(object sender, EventArgs e)
        {
            ...
            FormAuthConfirmation authForm = new FormAuthConfirmation(userIdChefEquipe, "chef_equipe", "update", taskId);
        ...
        private void ModifierTacheDansLaBase(string titre, string description,
         DateTime dateDebut, DateTime dateFin,string statut, int tempsEstime, List<int> nouveauxMembresIds)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    try
                    {
                        ...
                        SET Title = @Title,
                            ...
                            Status = @Status,EstimatedTime = @EstimatedTim   WHERE TaskID = @TaskID";
