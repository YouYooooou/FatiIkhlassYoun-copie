...
namespace FatiIkhlassYoun
{
    public partial class AjouterTache : Form
    {
        ...
        private void btnAjouter_Click(object sender, EventArgs e)
        {
            ...
            FormAuthConfirmation authForm = new FormAuthConfirmation(userIdChefEquipe, "chef_equipe", "add", 0);            
        ...
        public bool AjouterTacheDansLaBase(int projectId, string titre, string description,DateTime dateDebut, DateTime dateFin,
